                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <i class="fa fa-th me-2"></i>Vendor Managemennt</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th me-2"></i>Staff Management</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ asset(route('admin.vendor.index')) }}" class="dropdown-item">All Staff</a>
